                        ...
                        >
                            ...
                            <div style={{ marginBottom: '3rem' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0 }}>
                                    <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}><strong>Teléfono:</strong> <a href="tel:+56937784243" className="text-light" style={{ textDecoration: 'none', color: 'inherit' }}>+56 9 3778 4243</a></li>
                                    <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}><strong>WhatsApp:</strong> <a href="https://wa.me/56937784243" target="_blank" rel="noopener noreferrer" className="text-light" style={{ textDecoration: 'none', color: 'inherit' }}>+56 9 3778 4243</a></li>
