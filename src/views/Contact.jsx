                        ...
                        >
                            ...
                            <div style={{ marginBottom: '3rem' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0 }}>
                                    <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}><strong>Teléfono:</strong> <a href="tel:+56937784243" className="text-light" style={{ textDecoration: 'none', color: 'inherit' }}>+56 9 8889 7033</a></li>
