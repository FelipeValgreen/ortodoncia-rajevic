        ...
        <>
            ...
            <section className="section" style={{ backgroundColor: '#f0f5f9' }}>
                <div className="container text-center">
                    ...
                    >
                        <h2 style={{ fontSize: '2rem', marginBottom: '1rem', color: 'var(--color-primary)' }}>¿Tiene dudas sobre su indicación quirúrgica?</h2>
                        <p style={{ fontSize: '1.1rem', color: 'var(--color-text-light)', marginBottom: '2rem', lineHeight: '1.6' }}>
                            Revise nuestra guía clínica exhaustiva sobre cómo el Dr. Rajevic audita planes de cirugía ortognática para maximizar el éxito en pabellón.
                        </p>
