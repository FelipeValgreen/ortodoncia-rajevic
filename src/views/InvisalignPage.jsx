    ...
    return (
        <>
            <SEO
                ...
                videoId="YOUR_YOUTUBE_VIDEO_ID_HERE" // Reemplazar con ID real de YouTube
            ...
            <section style={{ padding: '6rem 0', textAlign: 'center', backgroundColor: 'var(--color-primary)', color: 'white' }}>
                <div className="container">
                    ...
                    >
                        ...
                        <Link href="/contacto" className="btn" style={{ padding: '1.2rem 3rem', backgroundColor: 'white', color: 'var(--color-primary)', border: 'none' }}>
            ...
            <section className="section" style={{ backgroundColor: '#f0f5f9' }}>
                <div className="container text-center">
                    ...
                    >
                        ...
                        <Link href="/guia-invisalign-chile" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
