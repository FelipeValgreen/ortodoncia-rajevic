        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', justifyContent: 'flex-end', flexWrap: 'wrap' }}>
              <Link href="/diagnostico-ortodoncia-vitacura" className="btn btn-primary" style={{ padding: '1.2rem 2.5rem', backgroundColor: 'var(--color-primary)', color: 'white', borderColor: 'var(--color-primary)', fontWeight: 'bold' }}>
        ...
        <div className="container">
          <div className="grid-2" style={{ alignItems: 'center', gap: '4rem' }}>
            <div style={{ position: 'relative', width: '100%', aspectRatio: '1/1' }}>
              <Image
                src={drRajevicImg}
                alt="Dr Rajevic en Consulta"
                fill
                sizes="(max-width: 768px) 100vw, 600px"
                style={{ borderRadius: 'var(--border-radius)', objectFit: 'cover', filter: 'grayscale(100%)', transition: 'filter 0.3s' }}
      ...
      <section className="section" style={{ backgroundColor: '#f8fafc' }}>
        <div className="container">
          ...
          <div className="text-center" style={{ marginTop: '2rem' }}>
            <Link href="/blog" className="btn-link">Ver todos los artículos &rarr;</Link>
          </div>
        </div>
      </section>
