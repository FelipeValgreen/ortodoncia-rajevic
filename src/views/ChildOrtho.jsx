                    ...
                    <div className="grid-2" style={{ gap: '4rem', alignItems: 'center' }}>
                        ...
                        <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: 'var(--border-radius)', boxShadow: 'var(--box-shadow)' }}>
                            ...
                            <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
                                <Link href="/contacto" className="btn btn-outline" style={{ width: '100%' }}>Agendar Chequeo</Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="grid-2" style={{ gap: '4rem', alignItems: 'center' }}>
                        ...
                        <div>
                            ...
                            <Link href="/dr-zdenko-rajevic" style={{ color: 'var(--color-primary)', fontWeight: 'bold', textDecoration: 'underline' }}>
