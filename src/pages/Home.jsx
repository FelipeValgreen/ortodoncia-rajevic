          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0', border: '1px solid var(--color-border)' }}>
            ...
            <div style={{ padding: '4rem 2rem', borderRight: '1px solid var(--color-border)', backgroundColor: '#fff' }}>
              ...
              <p style={{ fontSize: '0.95rem', color: 'var(--color-text-light)' }}>
                Análisis exhaustivo de ATM, estructura ósea y función. Entender antes de actuar.
              </p>
            </div>
            ...
            <div style={{ padding: '4rem 2rem', borderRight: '1px solid var(--color-border)', backgroundColor: '#fff' }}>
              ...
              <h3 style={{ marginBottom: '1rem' }}>Planificación</h3>
              <p style={{ fontSize: '0.95rem', color: 'var(--color-text-light)' }}>
                Diseño digital y estrategia clínica. Definimos el destino antes de dar el primer paso.
              </p>
            </div>
            ...
            <div style={{ padding: '4rem 2rem', backgroundColor: '#fff' }}>
              ...
              <h3 style={{ marginBottom: '1rem' }}>Tratamiento</h3>
              <p style={{ fontSize: '0.95rem', color: 'var(--color-text-light)' }}>
                Ejecución técnica impecable, ya sea con alineadores o aparotología fija.
              </p>
            </div>
